...
const translations = {
  en: {
    ...
    "about.role.value":       "AI & Computer Engineer at AISOFT",
    "about.location.label":   "Location",
    "about.location.value":   "Bursa, Turkey",
    ...
    "about.desc1":            "I'm an AI & Computer Engineer at AISOFT (Bursa, Turkey), where I build computer vision systems and industrial AI solutions that solve real manufacturing challenges — from automated glass fragmentation analysis to thermal anomaly detection at scale.",
  ...
  tr: {
    ...
    "about.role.value":       "AISOFT'ta Yapay Zeka & Bilgisayar Mühendisi",
    "about.location.label":   "Konum",
    "about.location.value":   "Bursa, Türkiye",
    ...
    "about.desc1":            "AISOFT'ta (Bursa, Türkiye) Yapay Zeka & Bilgisayar Mühendisiyim. Otomatik cam kırılma analizinden ölçeklenebilir termal anomali tespitine kadar gerçek üretim sorunlarını çözen bilgisayarlı görü sistemleri ve endüstriyel yapay zeka çözümleri geliştiriyorum.",
